        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm">© 2025 Notion Labs, Inc.</p>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/about" className="text-sm text-[#31302e] hover:text-gray-600">
                    About us
                  </a>
                </li>
                <li>
                  <a href="/careers" className="text-sm text-[#31302e] hover:text-gray-600">
                    Careers
                  </a>
                </li>
                <li>
                  <a href="/security" className="text-sm text-[#31302e] hover:text-gray-600">
                    Security
                  </a>
                </li>
                <li>
                  <a href="https://status.notion.so" className="text-sm text-[#31302e] hover:text-gray-600">
                    Status
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="text-sm text-[#31302e] hover:text-gray-600"
                  >
                    Terms & privacy
                  </a>
                </li>
            ...
            {/* Download Links */}
            <div>
              <h3 className="font-semibold text-base mb-4">Download</h3>
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="/mobile" className="text-sm hover:text-gray-600">
                    iOS & Android
                  </a>
                </li>
                <li>
                  <a href="/desktop" className="text-sm hover:text-gray-600">
                    Mac & Windows
                  </a>
                </li>
                <li>
                  <a href="/product/calendar/download" className="text-sm hover:text-gray-600">
                    Calendar
                  </a>
                </li>
                <li>
                  <a href="/web-clipper" className="text-sm hover:text-gray-600">
                    Web Clipper
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/help" className="text-sm hover:text-gray-600">
                    Help center
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/blog" className="text-sm hover:text-gray-600">
                    Blog
                  </a>
                </li>
                <li>
                  <a href="/community" className="text-sm hover:text-gray-600">
                    Community
                  </a>
                </li>
                <li>
                  <a href="/integrations" className="text-sm hover:text-gray-600">
                    Integrations
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/affiliates" className="text-sm hover:text-gray-600">
                    Affiliates
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="/teams" className="text-sm hover:text-gray-600">
                    Small business
                  </a>
                </li>
                <li>
                  <a href="/personal" className="text-sm hover:text-gray-600">
                    Personal
                  </a>
                </li>
              </ul>
              <div className="mt-6 ">
                <a
                  href="/explore"
                  className="font-bold text-sm text-black hover:text-gray-600 inline-flex items-center justify-end"
                >
                  Explore more
