        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-4">
              <Link href="https://www.instagram.com/notionhq/" target="_blank" rel="noopener" aria-label="Instagram">
              ...
              <Link href="https://twitter.com/NotionHQ" target="_blank" rel="noopener" aria-label="Twitter">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <Link href="https://www.facebook.com/NotionHQ/" target="_blank" rel="noopener" aria-label="Facebook">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="col-span-1 md:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/careers" className="text-base hover:text-gray-600">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link href="/security" className="text-base hover:text-gray-600">
                    Security
                  </Link>
                </li>
                <li>
                  <Link href="https://status.notion.so" className="text-base hover:text-gray-600">
                    Status
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/mobile" className="text-base hover:text-gray-600">
                    iOS & Android
                  </Link>
                </li>
                <li>
                  <Link href="/desktop" className="text-base hover:text-gray-600">
                    Mac & Windows
                  </Link>
                </li>
                <li>
                  <Link href="/product/calendar/download" className="text-base hover:text-gray-600">
                    Calendar
                  </Link>
                </li>
                <li>
                  <Link href="/web-clipper" className="text-base hover:text-gray-600">
                    Web Clipper
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/help" className="text-base hover:text-gray-600">
                    Help center
                  </Link>
                </li>
                <li>
                  <Link href="/pricing" className="text-base hover:text-gray-600">
                    Pricing
                  </Link>
                </li>
                <li>
                  <Link href="/blog" className="text-base hover:text-gray-600">
                    Blog
                  </Link>
                </li>
                <li>
                  <Link href="/community" className="text-base hover:text-gray-600">
                    Community
                  </Link>
                </li>
                <li>
                  <Link href="/integrations" className="text-base hover:text-gray-600">
                    Integrations
                  </Link>
                </li>
                <li>
                  <Link href="/templates" className="text-base hover:text-gray-600">
                    Templates
                  </Link>
                </li>
                <li>
                  <Link href="/affiliates" className="text-base hover:text-gray-600">
                    Affiliates
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/enterprise" className="text-base hover:text-gray-600">
                    Enterprise
                  </Link>
                </li>
                <li>
                  <Link href="/teams" className="text-base hover:text-gray-600">
                    Small business
                  </Link>
                </li>
                <li>
                  <Link href="/personal" className="text-base hover:text-gray-600">
                    Personal
                  </Link>
                </li>
              </ul>
