    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div className="md:col-span-2 order-2 md:order-3">
        <div className="aspect-video bg-muted rounded-lg flex items-center justify-center mb-8">
          <video src='https://www.notion.com/front-static/pages/product/super-duper/ai/ai-screen-desktop.mp4' autoPlay muted playsInline className="w-full h-full object-cover" />
        </div>
      </div>
